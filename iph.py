    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                kc.sendText(msg.to,Cmid)
            elif msg.text in ["Wkwkwk","Wkwk","Wk","wkwkwk","wkwk","spm"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Hehehe","Hehe","He","hehehe","hehe","spm"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Hmmm","Hmm","Hm","hmmm","hmm","spm"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "101",
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tagall User Finish-------------#
        ...
        #-------------Fungsi Spam Start---------------------#
                ...
                cl.sendText(msg.to,"P ??􀆶squared up!??")
