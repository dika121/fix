...
cl = LINETCR.LINE()
cl.login(token='EkM0lT8fchXVuuYru362.37apuNHgOzBUButCBQXbyG.MYP3QEe/r+TxBzg9zoVsDvygozfyInayhOyZsGCAt1Y=')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='EkrgvU4qKJgmGASSkJdc.uCWFQOB/MvfQf3dFLBysda.HXbFxShwDxcgxCKXbj0mdyoMCH+PbpTM2H7VzygYo4c=')
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token='EkosP6NxQMtz1cIbSbub.gsAa3gA1p+gvCNtTMc8GoW.0OXjG0vxYOOUHoOJN3LmModjhe78p3c/hCR/TgQYSh0=')
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token='EkZi64xduxLwwTOI6A05.rb40y3Su137/1Dpq+Qh/Pq.OGO0rQEv2P6adczc4xIUhhdQt54E7900tNwqMIQQXyM=')
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token='Ekv7DTrHOwbgtwVaEbyd.f2qKH7z9Vam8UA5s1cN6Zq.JpfDi0j8U4f8Q7285f8n+pWrWDbdoy5ahMq4mZ7+h8U=')
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token='EkxqZv58qQV120njJFSc.N5OjwnyMFZQANF4tEWxAZa./qyrOof6v4AdaTIhPtxHWXHvKAhmD58uiNDPX9dkH04=')
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token='EkgxTm5VbVSWMux4Ju67.Z164UOSS5be+ggZtJGDXrW.zAJcWIoRgPBrOy5sKS9XZHlblHT39pxs2tPJ+e0ejso=')
ki6.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u9e5a757e7b6e466baf87e8f747d96eb5"]
admin=["u9e5a757e7b6e466baf87e8f747d96eb5",mid]
...
#-----------------------------------------------
            	...
            	if msg.from_ in admin:
                    if msg.toType == 2:
                        print "[Unbanned]ok"
                        _name = msg.text.replace("Unbanned @","")
                        _nametarget = _name.rstrip('  ')
                        gs = cl.getGroup(msg.to)
                        targets = []
                        for g in gs.members:
